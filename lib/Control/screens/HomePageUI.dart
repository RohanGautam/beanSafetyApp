...
import 'package:firebase_tutorial/Control/screens/EmergencyContactsUI.dart';
import 'package:firebase_tutorial/Control/screens/EmergencyServicesUI.dart';
import 'package:firebase_tutorial/Control/screens/AlertOthersUI.dart';
            ...
            children: <Widget>[
              Positioned(
                  ...
                  top: MediaQuery.of(context).size.width *
                      0.08, //TRY TO CHANGE THIS **0.30** value to achieve your goal
                  child: Container(
                    ...
                    child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            'Bi-directional Emergency And Notification System',
                ...
                child: GridView.count(
                  ...
                  children: <Widget>[
                    RoundIconButton(
                      ...
                      mpr: MaterialPageRoute(builder: (context) => AlertMeUI()),
                      text: 'ALERT ME',
                    ),
                    RoundIconButton(
